...
func metricInfoContext(t *testing.T, locale language.Tag) context.Context {
	...
	require.NoError(t, bundle.AddMessages(language.English,
		...
		&i18n.Message{ID: "Chart.ExportFailed", Other: "Export failed. Please try again."},
	...
	require.NoError(t, bundle.AddMessages(language.Russian,
		...
		&i18n.Message{ID: "Chart.ExportFailed", Other: "Не удалось сформировать отчёт. Попробуйте ещё раз."},
