		...
		Map: &MapConfig{
			Source: GeoJSONSource{Inline: &GeoJSONFeatureCollection{
				...
				Features: []GeoJSONFeature{
					{Type: "Feature", Properties: map[string]any{"code": "north", "name": "North"}, Geometry: map[string]any{"type": "Polygon", "coordinates": []any{[]any{}}}},
					{Type: "Feature", Properties: map[string]any{"code": "south", "name": "South"}, Geometry: map[string]any{"type": "MultiPolygon", "coordinates": []any{[]any{}}}},
				},
			}},
