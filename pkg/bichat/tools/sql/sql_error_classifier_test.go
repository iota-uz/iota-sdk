...
func TestClassifySQLError_UndefinedColumn(t *testing.T) {
	...
	if diagnosis.Code != tools.ErrCodeColumnNotFound {
		t.Errorf("expected code %s, got %s", tools.ErrCodeColumnNotFound, diagnosis.Code)
	}
...
func TestClassifySQLError_UndefinedTable(t *testing.T) {
	...
	if diagnosis.Code != tools.ErrCodeTableNotFound {
		t.Errorf("expected code %s, got %s", tools.ErrCodeTableNotFound, diagnosis.Code)
	}
...
func TestClassifySQLError_TypeMismatch(t *testing.T) {
	...
	if diagnosis.Code != tools.ErrCodeTypeMismatch {
		t.Errorf("expected code %s, got %s", tools.ErrCodeTypeMismatch, diagnosis.Code)
	}
...
func TestClassifySQLError_SyntaxError(t *testing.T) {
	...
	if diagnosis.Code != tools.ErrCodeSyntaxError {
		t.Errorf("expected code %s, got %s", tools.ErrCodeSyntaxError, diagnosis.Code)
	}
...
func TestClassifySQLError_AmbiguousColumn(t *testing.T) {
	...
	if diagnosis.Code != tools.ErrCodeAmbiguousColumn {
		t.Errorf("expected code %s, got %s", tools.ErrCodeAmbiguousColumn, diagnosis.Code)
	}
...
func TestClassifySQLError_NilError(t *testing.T) {
	...
	if diagnosis.Code != tools.ErrCodeQueryError {
		t.Errorf("expected code %s, got %s", tools.ErrCodeQueryError, diagnosis.Code)
	}
