...
// PostgresCheckpointer moved to modules/bichat/infrastructure/persistence/postgres_checkpointer.go
// to remove dependency on pkg/composables from foundation package.
