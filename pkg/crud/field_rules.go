...
func MinValueRule(minValue float64) FieldRule {
	return func(fv FieldValue) error {
		...
		case DecimalFieldType:
			...
			return nil
		case StringFieldType, BoolFieldType, DateFieldType, TimeFieldType, DateTimeFieldType, TimestampFieldType, UUIDFieldType, JSONFieldType, EntityFieldType:
...
func NonNegativeRule() FieldRule {
	return func(fv FieldValue) error {
		...
		case StringFieldType, BoolFieldType, DateFieldType, TimeFieldType, DateTimeFieldType, TimestampFieldType, UUIDFieldType, DecimalFieldType, JSONFieldType, EntityFieldType:
...
func WeekdayRule() FieldRule {
	return func(fv FieldValue) error {
		...
		case DateFieldType, DateTimeFieldType, TimestampFieldType:
			...
			return nil
		case StringFieldType, IntFieldType, BoolFieldType, FloatFieldType, TimeFieldType, UUIDFieldType, DecimalFieldType, JSONFieldType, EntityFieldType:
