...
console.log('2. Install in applet: npm install @iotauz/tailwind-preset')
console.log('3. Use in tailwind.config.js: const iotaPreset = require("@iotauz/tailwind-preset")')
