...
func TestExportDropdown_DownloadMode(t *testing.T) {
	...
	// Per-format triggers wired to runExport with the format param. Single quotes
	// render as &#39; in the attribute value (the browser/Alpine decode them).
	assert.Contains(t, html, "runExport(&#39;excel&#39;)")
	assert.Contains(t, html, "runExport(&#39;csv&#39;)")
}
