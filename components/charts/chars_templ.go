...
func graph(id string, options templ.JSExpression) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_graph_ab0a`,
		Function: `function __templ_graph_ab0a(id, options){const renderChart = () => {
	...
	document.addEventListener('sdk:rerenderCharts', () => renderChart());
		...
		Call:       templ.SafeScript(`__templ_graph_ab0a`, id, options),
		CallInline: templ.SafeScriptInline(`__templ_graph_ab0a`, id, options),
	}
}
...
func Chart(props Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/charts/chars.templ`, Line: 60, Col: 9}
		}
