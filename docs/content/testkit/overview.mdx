...
Generate OTP for a specific user (for test login flows).

### GET /__test__/otp/{'{userID}'}

Get current OTP for a specific user.

### GET /__test__/otp

Get OTP by identifier (e.g. query parameter such as email or phone).
