...
The only test-related variable in the central configuration is **`ENABLE_TEST_ENDPOINTS`**. Variables such as `TEST_ENDPOINTS_ALLOWED_IPS` or `TEST_DATABASE_URL` may be used by specific test harnesses or CI; check your test setup for support.
