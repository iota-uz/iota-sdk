...
|------------|-------------|
| `Position.Read`, `Position.Create`, `Position.Update`, `Position.Delete` | Product catalog (positions) |
| `Product.Read`, `Product.Create`, `Product.Update`, `Product.Delete` | Products |
| `Order.Read`, `Order.Create`, `Order.Update`, `Order.Delete` | Orders |
| `Unit.Read`, `Unit.Create`, `Unit.Update`, `Unit.Delete` | Units |
