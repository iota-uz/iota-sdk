...
- Branding (logos, colors: %v", err)
- Feature flags (enable/disable modules: %v", err)
- Default settings (date formats, number formats: %v", err)
- Custom fields (extend entities: %v", err)
