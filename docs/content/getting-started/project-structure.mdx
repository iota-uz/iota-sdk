...
└── finance-schema.sql      # Schema; migrations may live here or in a central migrations dir
```
...
```bash
DB_NAME=... DB_HOST=... DB_PORT=... DB_USER=... DB_PASSWORD=...  # Database (connection built from these)
GO_APP_ENV=development|production  # Environment mode
PORT=3200                         # Server port
SID_COOKIE_KEY=...               # Session cookie name (session is DB-backed)
