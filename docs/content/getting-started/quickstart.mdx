...
3. **Apply a Profile** - Use `application.ApplyProfile(ctx, app, application.CompositionProfileServer, yourModule)` or call `application.Wire(...)` and `application.RegisterTransports(...)` directly when you need finer control
