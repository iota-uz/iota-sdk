...
|----------|--------|------|
| **Click** | Uzbekistan | Local payment |
| **Payme** | Uzbekistan | Local payment |
...
sequenceDiagram
    ...
    BillingService->>Database: Create transaction (Pending)
    ...
    BillingService->>Database: Update status (Completed)
