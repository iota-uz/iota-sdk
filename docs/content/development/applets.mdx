...
- `IOTA_APPLET_ENGINE_BICHAT_SECRETS_BACKEND=postgres`
- `IOTA_APPLET_ENGINE_SECRETS_MASTER_KEY=<base64-encoded 32-byte key>`
...
- `IOTA_APPLET_ENGINE_BICHAT_FILES_BACKEND=postgres`
- `IOTA_APPLET_ENGINE_FILES_DIR=/var/lib/iota/applet-files` (optional; defaults to temp dir)
