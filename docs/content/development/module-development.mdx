...
func (c *component) Build(builder *composition.Builder) error {
	...
	// ProvideFuncAs registers an interface key and a concrete key with a
	// single call; consumers depending on product.Repository will resolve
	// the same value as consumers depending on *persistence.ProductRepository.
