...
func (c *component) Build(builder *composition.Builder) error {
	...
	productService := composition.Use[*services.ProductService]()
	...
	composition.Provide[*services.ProductService](builder, func(container *composition.Container) (*services.ProductService, error) {
		resolvedRepo, err := productRepo.Resolve(container)
		if err != nil {
			return nil, err
		}
		return services.NewProductService(resolvedRepo, builder.Context().EventPublisher()), nil
	})
	...
	if builder.Context().HasCapability(composition.CapabilityAPI) {
		composition.ContributeControllers(builder, func(container *composition.Container) ([]application.Controller, error) {
			...
			resolvedService, err := productService.Resolve(container)
			if err != nil {
				return nil, err
			}
			return []application.Controller{
				controllers.NewProductController(app, resolvedService),
			}, nil
		})
	}
