...
The Logging module does not register HTTP controllers. It provides **locale files and persistence schema** (migrations) only. Authentication and action logging behavior (e.g. middleware, storage) may be implemented by other modules or the application. The following endpoints are not part of the current Logging module implementation and are shown for conceptual reference only:

| Endpoint | Method | Purpose (conceptual) |
|----------|--------|----------------------|
