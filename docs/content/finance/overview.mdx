...
- Debt tracking (receivables and payables: %v", err)
- Financial reporting (Income Statement, Cashflow: %v", err)
...
- Can have attachments (documents, receipts: %v", err)
...
- **Payment Categories** - Income types (Sales, Services, etc.: %v", err)
- **Expense Categories** - Spending types (Rent, Salaries, etc.: %v", err)
