...
The Finance module does not register a GraphQL schema. It exposes **REST endpoints and server-rendered UI** only (e.g. `/finance/accounts`, `/finance/payments`, `/finance/expenses`). Use the Core and Warehouse modules for GraphQL APIs.
