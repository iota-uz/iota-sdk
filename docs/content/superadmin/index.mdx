...
The SuperAdmin app (separate binary, port 4000) registers:
...
There are no dedicated `/superadmin/dashboard`, `/superadmin/analytics`, or `/superadmin/users` routes; dashboard and metrics are served at `/` and `/metrics`.
