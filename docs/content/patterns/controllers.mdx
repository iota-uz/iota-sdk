...
func (c *ExpenseController) Delete(...) {
	...
	if htmx.IsHxRequest(r) {
		// Return empty response with trigger (detail is a string, e.g. ID or JSON)
		htmx.SetTrigger(w, "expenseDeleted", id.String())
	} else {
		shared.Redirect(w, r, c.basePath)
	}
}
...
func TestExpenseController_Create(t *testing.T) {
	...
	t.Run("create expense", func(t *testing.T) {
		...
		// Create test account and category (e.g. via testkit seed or createTestAccount/createTestCategory helpers)
		accountID := "00000000-0000-0000-0000-000000000001" // from fixture
		categoryID := "00000000-0000-0000-0000-000000000002" // from fixture
