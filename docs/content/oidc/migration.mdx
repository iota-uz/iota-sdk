---
title: 'OIDC Migration Guide'
description: 'Step-by-step guide to enable OIDC on an existing installation'
---
...
1. Review [API Reference](/oidc/api) for endpoint details
2. Review [Configuration Guide](/oidc/configuration) for advanced settings
