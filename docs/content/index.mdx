...
Start with [Getting Started](/getting-started) to learn how to install and set up IOTA SDK for development. Then explore [Architecture](/architecture), [Patterns](/patterns) (repositories, services, controllers), and [Development](/development) (module development, applets, complex features).
...
- [Patterns](/patterns) — Repository, service, and controller patterns with HTMX
- [Development](/development) — Building modules, applets, complex features
- [API Reference](/api) — GraphQL and REST APIs
- [Advanced](/advanced) — TOTP encryption, advanced topics
