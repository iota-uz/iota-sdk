...
Start with [Getting Started](/getting-started) to learn how to install and set up IOTA SDK for development. Then explore [Architecture](/architecture), [Patterns](/patterns/repositories) (repositories, services, controllers), and [Development](/development/module-development) (module development, applets, complex features).

## Documentation Map

- [Getting Started](/getting-started) — Installation, quick start, project structure
- [Architecture](/architecture) — DDD, module system, multi-tenancy, frontend stack
- [Patterns](/patterns/repositories) — Repository, service, and controller patterns with HTMX
- [Development](/development/module-development) — Building modules, applets, complex features
- [API Reference](/api) — GraphQL and REST APIs
- [Advanced](/advanced/overview) — TOTP encryption, advanced topics
