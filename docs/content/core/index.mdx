...
Other modules access Core services through typed composition handles:

```mermaid
graph LR
    A[Finance Component] -->|"composition.Use[*UserService]()"| B[UserService]
    C[Warehouse Component] -->|"composition.Use[upload.Repository]()"| D[UploadService]
    E[CRM Component] -->|"composition.Use[*SessionService]()"| F[SessionService]
```
