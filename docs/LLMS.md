...
- `func (TinValidationError) Error() string`
...
- `func (FSStorage) Rename(ctx context.Context, oldPath, newPath string) error`
...
- `func (GormUploadRepository) GetBySlug(ctx context.Context, slug string) (upload.Upload, error)`
...
- Var: `[UserCreate UserRead UserUpdate UserDelete RoleCreate RoleRead RoleUpdate RoleDelete GroupCreate GroupRead GroupUpdate GroupDelete UploadCreate UploadRead UploadUpdate UploadDelete]`

- Var: `[Permissions]`

- Const: `[ResourceUser ResourceRole ResourceGroup ResourceUpload]`
...
- `func (CrudController) RegisterRenderer(rendererType string, renderer crud.FieldRenderer)`
...
- `func (ShowcaseController) Kanban(r *http.Request, w http.ResponseWriter, logger *logrus.Entry)`
...
- `func (ShowcaseController) Tooltips(r *http.Request, w http.ResponseWriter, logger *logrus.Entry)`
...
#### `func BuildModulePermissionGroups(schema *rbac.PermissionSchema, selected ...*permission.Permission) []*viewmodels.ModulePermissionGroup`
...
#### `func BuildResourcePermissionGroups(schema *rbac.PermissionSchema, selected ...*permission.Permission) []*viewmodels.ResourcePermissionGroup`
...
#### `func NewCrudShowcaseController(app application.Application, opts ...<?>) application.Controller`
...
- `func (CreateRoleDTO) ToEntity(schema *rbac.PermissionSchema) (role.Role, error)`
...
- `func (UpdateRoleDTO) Apply(roleEntity role.Role, schema *rbac.PermissionSchema) (role.Role, error)`
...
- Var: `[EditableTableComponentSource]`

- Var: `[HeatmapChartSource]`

- Var: `[InputComponentSource]`

- Var: `[KanbanBoardSource]`
...
- `func (RoleService) Create(ctx context.Context, data role.Role) (role.Role, error)`
...
- `func (UploadService) GetBySlug(ctx context.Context, slug string) (upload.Upload, error)`
...
- `func (ClientController) Export(r *http.Request, w http.ResponseWriter, logger *logrus.Entry, user userdomain.User, clientService *services.ClientService, excelService *coreservicse.ExcelExportService, uploadService *coreservicse.UploadService)`
...
- Var: `[TransactionsItem ExpenseCategoriesItem PaymentCategoriesItem PaymentsItem ExpensesItem AccountsItem CounterpartiesItem InventoryItem DebtsItem DebtAggregatesItem EnumsItem ReportsItem]`
...
## Package `debt` (modules/finance/domain/aggregates/debt)
...
## Package `value_objects` (modules/finance/domain/value_objects)
...
- `func (IncomeStatement) IsProfit() bool`
  IsProfit returns true if the statement shows a profit
  

- `func (IncomeStatement) Period() string`
...
- `func (GormDebtRepository) Count(ctx context.Context) (int64, error)`

- `func (GormDebtRepository) Create(ctx context.Context, data debt.Debt) (debt.Debt, error)`

- `func (GormDebtRepository) Delete(ctx context.Context, id uuid.UUID) error`

- `func (GormDebtRepository) GetAll(ctx context.Context) ([]debt.Debt, error)`

- `func (GormDebtRepository) GetByCounterpartyID(ctx context.Context, counterpartyID uuid.UUID) ([]debt.Debt, error)`

- `func (GormDebtRepository) GetByID(ctx context.Context, id uuid.UUID) (debt.Debt, error)`

- `func (GormDebtRepository) GetCounterpartyAggregates(ctx context.Context) ([]debt.CounterpartyAggregate, error)`

- `func (GormDebtRepository) GetPaginated(ctx context.Context, params *debt.FindParams) ([]debt.Debt, error)`

- `func (GormDebtRepository) Update(ctx context.Context, data debt.Debt) (debt.Debt, error)`

#### GormExpenseRepository

##### Methods

- `func (GormExpenseRepository) AttachFile(ctx context.Context, expenseID uuid.UUID, uploadID uint) error`
...
- `func (GormExpenseRepository) DetachFile(ctx context.Context, expenseID uuid.UUID, uploadID uint) error`
...
- `func (GormExpenseRepository) GetAttachments(ctx context.Context, expenseID uuid.UUID) ([]uint, error)`
...
- `func (GormMoneyAccountRepository) Count(ctx context.Context, params *moneyaccount.FindParams) (int64, error)`
...
- `func (GormPaymentRepository) AttachFile(ctx context.Context, paymentID uuid.UUID, uploadID uint) error`
...
- `func (GormPaymentRepository) DetachFile(ctx context.Context, paymentID uuid.UUID, uploadID uint) error`
...
- `func (GormPaymentRepository) GetAttachments(ctx context.Context, paymentID uuid.UUID) ([]uint, error)`
...
## Package `query` (modules/finance/infrastructure/query)
...
#### FinancialReportsQueryRepository
...
type MonthlyCashflowLineItem struct {
    CategoryID uuid.UUID
    CategoryName string
    MonthlyAmounts map[string]*money.Money
...
- Var: `[PaymentCreate PaymentRead PaymentUpdate PaymentDelete ExpenseCreate ExpenseRead ExpenseUpdate ExpenseDelete ExpenseCategoryCreate ExpenseCategoryRead ExpenseCategoryUpdate ExpenseCategoryDelete DebtCreate DebtRead DebtUpdate DebtDelete]`

- Var: `[Permissions]`

- Const: `[ResourceExpense ResourcePayment ResourceExpenseCategory ResourceDebt]`
...
- `func (CashflowController) GenerateCashflowStatement(w http.ResponseWriter, r *http.Request)`
  GenerateCashflowStatement handles form submission for cashflow statement generation
  

- `func (CashflowController) GetCashflowStatementData(w http.ResponseWriter, r *http.Request)`
  GetCashflowStatementData returns cashflow statement data as JSON
  

- `func (CashflowController) GetCashflowStatementPage(w http.ResponseWriter, r *http.Request)`
  GetCashflowStatementPage renders the cashflow statement page
  

- `func (CashflowController) Key() string`

- `func (CashflowController) Register(r *mux.Router)`
...
#### DebtAggregateController

##### Methods

- `func (DebtAggregateController) GetCounterpartyDrawer(w http.ResponseWriter, r *http.Request)`

- `func (DebtAggregateController) Key() string`

- `func (DebtAggregateController) List(w http.ResponseWriter, r *http.Request)`

- `func (DebtAggregateController) Register(r *mux.Router)`

#### DebtsController

##### Methods

- `func (DebtsController) Create(w http.ResponseWriter, r *http.Request)`

- `func (DebtsController) Delete(w http.ResponseWriter, r *http.Request)`

- `func (DebtsController) GetEditDrawer(w http.ResponseWriter, r *http.Request)`

- `func (DebtsController) GetNewDrawer(w http.ResponseWriter, r *http.Request)`

- `func (DebtsController) Key() string`

- `func (DebtsController) List(w http.ResponseWriter, r *http.Request)`

- `func (DebtsController) Register(r *mux.Router)`

- `func (DebtsController) Settle(w http.ResponseWriter, r *http.Request)`

- `func (DebtsController) Update(w http.ResponseWriter, r *http.Request)`

- `func (DebtsController) WriteOff(w http.ResponseWriter, r *http.Request)`
...
- `func (ExpenseCategoriesController) GetEditDrawer(w http.ResponseWriter, r *http.Request)`

- `func (ExpenseCategoriesController) GetNewDrawer(w http.ResponseWriter, r *http.Request)`
...
- `func (ExpenseController) AttachFile(r *http.Request, w http.ResponseWriter, logger *logrus.Entry, expenseService *services.ExpenseService)`
...
- `func (ExpenseController) DetachFile(r *http.Request, w http.ResponseWriter, logger *logrus.Entry, expenseService *services.ExpenseService)`
...
- `func (ExpenseController) GetAccountsSelect(r *http.Request, w http.ResponseWriter, logger *logrus.Entry, moneyAccountService *services.MoneyAccountService)`

- `func (ExpenseController) GetCategoriesSelect(r *http.Request, w http.ResponseWriter, logger *logrus.Entry, expenseCategoryService *services.ExpenseCategoryService)`

- `func (ExpenseController) GetEdit(r *http.Request, w http.ResponseWriter, logger *logrus.Entry, expenseService *services.ExpenseService)`

- `func (ExpenseController) GetNew(r *http.Request, w http.ResponseWriter)`
...
- `func (FinancialOverviewController) Index(w http.ResponseWriter, r *http.Request)`

- `func (FinancialOverviewController) Key() string`

- `func (FinancialOverviewController) Register(r *mux.Router)`

#### FinancialReportController

##### Methods

- `func (FinancialReportController) GenerateIncomeStatement(w http.ResponseWriter, r *http.Request)`
  GenerateIncomeStatement handles form submission for income statement generation
  

- `func (FinancialReportController) GetIncomeStatementData(w http.ResponseWriter, r *http.Request)`
  GetIncomeStatementData returns income statement data as JSON for AJAX requests
  

- `func (FinancialReportController) GetIncomeStatementPage(w http.ResponseWriter, r *http.Request)`
  GetIncomeStatementPage renders the income statement page
  

- `func (FinancialReportController) Key() string`

- `func (FinancialReportController) Register(r *mux.Router)`
...
- `func (MoneyAccountController) CreateTransfer(w http.ResponseWriter, r *http.Request)`

- `func (MoneyAccountController) Delete(w http.ResponseWriter, r *http.Request)`

- `func (MoneyAccountController) GetAccountTransactions(w http.ResponseWriter, r *http.Request)`
  GetAccountTransactions handles the HTMX request for the transactions tab
  

- `func (MoneyAccountController) GetEditDrawer(w http.ResponseWriter, r *http.Request)`

- `func (MoneyAccountController) GetNewDrawer(w http.ResponseWriter, r *http.Request)`

- `func (MoneyAccountController) GetTransferDrawer(w http.ResponseWriter, r *http.Request)`
...
- `func (PaymentCategoriesController) GetEditDrawer(w http.ResponseWriter, r *http.Request)`

- `func (PaymentCategoriesController) GetNewDrawer(w http.ResponseWriter, r *http.Request)`
...
- `func (PaymentsController) AttachFile(r *http.Request, w http.ResponseWriter, logger *logrus.Entry, paymentService *services.PaymentService)`
...
- `func (PaymentsController) DetachFile(r *http.Request, w http.ResponseWriter, logger *logrus.Entry, paymentService *services.PaymentService)`
...
- `func (TransactionController) GetViewDrawer(w http.ResponseWriter, r *http.Request)`

- `func (TransactionController) Key() string`

- `func (TransactionController) List(w http.ResponseWriter, r *http.Request)`

- `func (TransactionController) Register(r *mux.Router)`
...
- `func (CashflowStatementRequestDTO) Ok(ctx context.Context) (map[string]string, bool)`
...
- `func (DebtCreateDTO) Ok(ctx context.Context) (map[string]string, bool)`

- `func (DebtCreateDTO) ToEntity(tenantID uuid.UUID) debt.Debt`
...
- `func (DebtSettleDTO) GetTransactionID() *uuid.UUID`

- `func (DebtSettleDTO) Ok(ctx context.Context) (map[string]string, bool)`
...
- `func (DebtUpdateDTO) Apply(existing debt.Debt) (debt.Debt, error)`

- `func (DebtUpdateDTO) Ok(ctx context.Context) (map[string]string, bool)`
...
- `func (IncomeStatementRequestDTO) Ok(ctx context.Context) (map[string]string, bool)`
...
- `func (TransactionFilterDTO) ToFindParams() *transaction.FindParams`
...
- `func (TransferDTO) GetDestinationAccountID() (uuid.UUID, error)`

- `func (TransferDTO) GetDestinationAmount() float64`

- `func (TransferDTO) GetExchangeRate() float64`

- `func (TransferDTO) Ok(ctx context.Context) (map[string]string, bool)`

- `func (TransferDTO) SetDestinationAmount(amount float64)`

- `func (TransferDTO) SetExchangeRate(rate float64)`
...
#### `func ToCashflowStatementViewModelWithMonthlyData(cashflowStatement *value_objects.CashflowStatement, accountName string, monthlyInflows []query.MonthlyCashflowLineItem, monthlyOutflows []query.MonthlyCashflowLineItem) *viewmodels.CashflowStatement`
...
#### `func ToIncomeStatementViewModelWithMonthlyData(incomeStatement *value_objects.IncomeStatement, monthlyIncomeData []query.MonthlyReportLineItem, monthlyExpenseData []query.MonthlyReportLineItem) *viewmodels.IncomeStatement`
...
## Package `debts` (modules/finance/presentation/templates/pages/debts)
...
## Package `financial_overview` (modules/finance/presentation/templates/pages/financial_overview)
...
## Package `reports` (modules/finance/presentation/templates/pages/reports)
...
## Package `transactions` (modules/finance/presentation/templates/pages/transactions)
...
- `func (DebtService) Count(ctx context.Context) (int64, error)`

- `func (DebtService) Create(ctx context.Context, entity debt.Debt) (debt.Debt, error)`

- `func (DebtService) Delete(ctx context.Context, id uuid.UUID) (debt.Debt, error)`

- `func (DebtService) GetAll(ctx context.Context) ([]debt.Debt, error)`

- `func (DebtService) GetByCounterpartyID(ctx context.Context, counterpartyID uuid.UUID) ([]debt.Debt, error)`

- `func (DebtService) GetByID(ctx context.Context, id uuid.UUID) (debt.Debt, error)`

- `func (DebtService) GetCounterpartyAggregates(ctx context.Context) ([]debt.CounterpartyAggregate, error)`

- `func (DebtService) GetPaginated(ctx context.Context, params *debt.FindParams) ([]debt.Debt, error)`

- `func (DebtService) Settle(ctx context.Context, debtID uuid.UUID, settlementAmount float64, transactionID *uuid.UUID) (debt.Debt, error)`

- `func (DebtService) Update(ctx context.Context, entity debt.Debt) (debt.Debt, error)`

- `func (DebtService) WriteOff(ctx context.Context, debtID uuid.UUID) (debt.Debt, error)`
...
- `func (ExpenseService) AttachFileToExpense(ctx context.Context, expenseID uuid.UUID, uploadID uint) error`
...
- `func (ExpenseService) DetachFileFromExpense(ctx context.Context, expenseID uuid.UUID, uploadID uint) error`
...
- `func (ExpenseService) GetExpenseAttachments(ctx context.Context, expenseID uuid.UUID) ([]uint, error)`
...
- `func (FinancialReportService) GenerateCashflowStatement(ctx context.Context, accountID uuid.UUID, startDate, endDate time.Time) (*value_objects.CashflowStatement, error)`
  GenerateCashflowStatement generates a cashflow statement for a specific account and period
  

- `func (FinancialReportService) GenerateIncomeStatement(ctx context.Context, startDate, endDate time.Time) (*value_objects.IncomeStatement, error)`
...
- `func (MoneyAccountService) Count(ctx context.Context, params *moneyaccount.FindParams) (int64, error)`
...
- `func (PaymentService) AttachFileToPayment(ctx context.Context, paymentID uuid.UUID, uploadID uint) error`
...
- `func (PaymentService) DetachFileFromPayment(ctx context.Context, paymentID uuid.UUID, uploadID uint) error`
...
- `func (PaymentService) GetPaymentAttachments(ctx context.Context, paymentID uuid.UUID) ([]uint, error)`
...
## Package `projects` (modules/projects)
...
- Var: `[ProjectsItem ProjectStagesItem]`

- Var: `[NavItems]`

---

## Package `project` (modules/projects/domain/aggregates/project)
...
## Package `projectstage` (modules/projects/domain/aggregates/project_stage)
...
## Package `persistence` (modules/projects/infrastructure/persistence)
...
- `func (ProjectRepository) Delete(ctx context.Context, id uuid.UUID) error`

- `func (ProjectRepository) GetAll(ctx context.Context) ([]project.Project, error)`

- `func (ProjectRepository) GetByCounterpartyID(ctx context.Context, counterpartyID uuid.UUID) ([]project.Project, error)`

- `func (ProjectRepository) GetByID(ctx context.Context, id uuid.UUID) (project.Project, error)`

- `func (ProjectRepository) GetPaginated(ctx context.Context, limit, offset int, sortBy []string) ([]project.Project, error)`

- `func (ProjectRepository) Save(ctx context.Context, proj project.Project) (project.Project, error)`

#### ProjectStageRepository

##### Methods

- `func (ProjectStageRepository) Count(ctx context.Context) (int64, error)`

- `func (ProjectStageRepository) Delete(ctx context.Context, id uuid.UUID) error`

- `func (ProjectStageRepository) GetAll(ctx context.Context) ([]projectstage.ProjectStage, error)`

- `func (ProjectStageRepository) GetByID(ctx context.Context, id uuid.UUID) (projectstage.ProjectStage, error)`

- `func (ProjectStageRepository) GetByProjectID(ctx context.Context, projectID uuid.UUID) ([]projectstage.ProjectStage, error)`

- `func (ProjectStageRepository) GetNextStageNumber(ctx context.Context, projectID uuid.UUID) (int, error)`

- `func (ProjectStageRepository) GetPaginated(ctx context.Context, limit, offset int, sortBy []string) ([]projectstage.ProjectStage, error)`

- `func (ProjectStageRepository) Save(ctx context.Context, stage projectstage.ProjectStage) (projectstage.ProjectStage, error)`

- `func (ProjectStageRepository) UpdatePaidAmounts(ctx context.Context, stageID uuid.UUID) error`
...
- Var: `[ErrProjectNotFound]`

- Var: `[ErrProjectStageNotFound]`

---

## Package `models` (modules/projects/infrastructure/persistence/models)
...
## Package `permissions` (modules/projects/permissions)

### Variables and Constants

- Var: `[ProjectCreate ProjectRead ProjectUpdate ProjectDelete ProjectStageCreate ProjectStageRead ProjectStageUpdate ProjectStageDelete]`

- Var: `[Permissions]`

- Const: `[ResourceProject ResourceProjectStage]`

---

## Package `controllers` (modules/projects/presentation/controllers)
...
- `func (ProjectController) Create(w http.ResponseWriter, r *http.Request, logger *logrus.Entry, projectService *projectServices.ProjectService, counterpartyService *services.CounterpartyService)`

- `func (ProjectController) Delete(w http.ResponseWriter, r *http.Request, logger *logrus.Entry, projectService *projectServices.ProjectService)`

- `func (ProjectController) GetEditDrawer(w http.ResponseWriter, r *http.Request, logger *logrus.Entry, projectService *projectServices.ProjectService, counterpartyService *services.CounterpartyService)`

- `func (ProjectController) GetNewDrawer(w http.ResponseWriter, r *http.Request, logger *logrus.Entry, counterpartyService *services.CounterpartyService)`

- `func (ProjectController) Key() string`

- `func (ProjectController) List(w http.ResponseWriter, r *http.Request, logger *logrus.Entry, projectService *projectServices.ProjectService)`

- `func (ProjectController) Register(r *mux.Router)`

- `func (ProjectController) Update(w http.ResponseWriter, r *http.Request, logger *logrus.Entry, projectService *projectServices.ProjectService, counterpartyService *services.CounterpartyService)`

#### ProjectStageController

##### Methods

- `func (ProjectStageController) Create(r *http.Request, w http.ResponseWriter, projectStageService *services.ProjectStageService, projectService *services.ProjectService)`

- `func (ProjectStageController) Delete(r *http.Request, w http.ResponseWriter, projectStageService *services.ProjectStageService)`

- `func (ProjectStageController) GetEditDrawer(r *http.Request, w http.ResponseWriter, projectStageService *services.ProjectStageService)`

- `func (ProjectStageController) GetNewDrawer(r *http.Request, w http.ResponseWriter, projectService *services.ProjectService)`

- `func (ProjectStageController) Key() string`

- `func (ProjectStageController) List(r *http.Request, w http.ResponseWriter, projectStageService *services.ProjectStageService)`

- `func (ProjectStageController) ListByProject(r *http.Request, w http.ResponseWriter, projectStageService *services.ProjectStageService)`

- `func (ProjectStageController) Register(r *mux.Router)`

- `func (ProjectStageController) Update(r *http.Request, w http.ResponseWriter, projectStageService *services.ProjectStageService)`
...
## Package `dtos` (modules/projects/presentation/controllers/dtos)
...
- `func (ProjectCreateDTO) Ok(ctx context.Context) (map[string]string, bool)`

- `func (ProjectCreateDTO) ToEntity(tenantID uuid.UUID) (project.Project, error)`

#### ProjectStageCreateDTO
...
- `func (ProjectStageCreateDTO) Ok(ctx context.Context) (map[string]string, bool)`

- `func (ProjectStageCreateDTO) ToEntity() projectstage.ProjectStage`
...
- `func (ProjectStageUpdateDTO) Apply(existing projectstage.ProjectStage) projectstage.ProjectStage`

- `func (ProjectStageUpdateDTO) Ok(ctx context.Context) (map[string]string, bool)`
...
- `func (ProjectUpdateDTO) Apply(existing project.Project) (project.Project, error)`

- `func (ProjectUpdateDTO) Ok(ctx context.Context) (map[string]string, bool)`

---

## Package `mappers` (modules/projects/presentation/mappers)
...
## Package `project_stages` (modules/projects/presentation/templates/pages/project_stages)
...
## Package `projects` (modules/projects/presentation/templates/pages/projects)
...
## Package `viewmodels` (modules/projects/presentation/viewmodels)
...
## Package `services` (modules/projects/services)
...
- `func (ProjectService) Create(ctx context.Context, proj project.Project) error`

- `func (ProjectService) Delete(ctx context.Context, id uuid.UUID) (project.Project, error)`

- `func (ProjectService) GetAll(ctx context.Context) ([]project.Project, error)`

- `func (ProjectService) GetByCounterpartyID(ctx context.Context, counterpartyID uuid.UUID) ([]project.Project, error)`

- `func (ProjectService) GetByID(ctx context.Context, id uuid.UUID) (project.Project, error)`

- `func (ProjectService) GetPaginated(ctx context.Context, limit, offset int, sortBy []string) ([]project.Project, error)`

- `func (ProjectService) Save(ctx context.Context, proj project.Project) (project.Project, error)`

- `func (ProjectService) Update(ctx context.Context, proj project.Project) error`

#### ProjectStageService

##### Methods

- `func (ProjectStageService) Count(ctx context.Context) (int64, error)`

- `func (ProjectStageService) Create(ctx context.Context, stage projectstage.ProjectStage) error`

- `func (ProjectStageService) Delete(ctx context.Context, id uuid.UUID) (projectstage.ProjectStage, error)`

- `func (ProjectStageService) GetAll(ctx context.Context) ([]projectstage.ProjectStage, error)`

- `func (ProjectStageService) GetByID(ctx context.Context, id uuid.UUID) (projectstage.ProjectStage, error)`

- `func (ProjectStageService) GetByProjectID(ctx context.Context, projectID uuid.UUID) ([]projectstage.ProjectStage, error)`

- `func (ProjectStageService) GetPaginated(ctx context.Context, limit, offset int, sortBy []string) ([]projectstage.ProjectStage, error)`

- `func (ProjectStageService) Save(ctx context.Context, stage projectstage.ProjectStage) (projectstage.ProjectStage, error)`

- `func (ProjectStageService) Update(ctx context.Context, stage projectstage.ProjectStage) error`

- `func (ProjectStageService) UpdatePaidAmounts(ctx context.Context, stageID uuid.UUID) error`
...
- `func (GormPositionRepository) Create(ctx context.Context, data position.Position) (position.Position, error)`

- `func (GormPositionRepository) CreateOrUpdate(ctx context.Context, data position.Position) (position.Position, error)`
...
- `func (GormPositionRepository) Update(ctx context.Context, data position.Position) (position.Position, error)`
...
- `func (PositionRowHandler) ExpectedColumnCount() int`
  ExpectedColumnCount returns the expected number of columns
  

- `func (PositionRowHandler) GetColumnName(index int) string`
  GetColumnName returns the name of the column at the given index
  

- `func (PositionRowHandler) ProcessRow(ctx context.Context, rowIndex int, row []string) error`
  ProcessRow processes a validated row
  

- `func (PositionRowHandler) ValidateRow(rowIndex int, row []string) error`
...
- `func (PositionsController) Create(r *http.Request, w http.ResponseWriter, positionService *positionservice.PositionService)`

- `func (PositionsController) Delete(r *http.Request, w http.ResponseWriter, positionService *positionservice.PositionService)`

- `func (PositionsController) DownloadTemplate(r *http.Request, w http.ResponseWriter, logger *logrus.Entry, localizer *i18n.Localizer)`

- `func (PositionsController) GetEdit(r *http.Request, w http.ResponseWriter, positionService *positionservice.PositionService, unitService *services.UnitService)`

- `func (PositionsController) GetNew(r *http.Request, w http.ResponseWriter, unitService *services.UnitService)`

- `func (PositionsController) GetUpload(r *http.Request, w http.ResponseWriter, logger *logrus.Entry, localizer *i18n.Localizer)`

- `func (PositionsController) HandleUpload(r *http.Request, w http.ResponseWriter, logger *logrus.Entry, localizer *i18n.Localizer, coreUploadService *coreservices.UploadService, positionService *positionservice.PositionService)`

- `func (PositionsController) Key() string`

- `func (PositionsController) List(r *http.Request, w http.ResponseWriter, positionService *positionservice.PositionService, unitService *services.UnitService)`

- `func (PositionsController) Register(r *mux.Router)`

- `func (PositionsController) Search(r *http.Request, w http.ResponseWriter, positionService *positionservice.PositionService)`

- `func (PositionsController) Update(r *http.Request, w http.ResponseWriter, positionService *positionservice.PositionService, unitService *services.UnitService)`
...
- `func (UploadFileAdapter) Path() string`
...
- `func (UploadServiceAdapter) GetByID(ctx context.Context, id uint) (importpkg.UploadFile, error)`
...
- `func (PositionService) CreatePositionFromXlsRow(ctx context.Context, xlsRow *XlsRow) error`
...
## Package `cache` (modules/website/domain/entities/cache)
...
## Package `cache` (modules/website/infrastructure/cache)
...
- `func (RedisCache) Delete(ctx context.Context, key string) error`

- `func (RedisCache) Get(ctx context.Context, key string) (string, error)`

- `func (RedisCache) Set(ctx context.Context, key, value string) error`
...
#### InmemThreadRepository

##### Methods

- `func (InmemThreadRepository) Delete(ctx context.Context, id uuid.UUID) error`

- `func (InmemThreadRepository) GetByID(ctx context.Context, id uuid.UUID) (chatthread.ChatThread, error)`

- `func (InmemThreadRepository) List(ctx context.Context) ([]chatthread.ChatThread, error)`

- `func (InmemThreadRepository) Save(ctx context.Context, thread chatthread.ChatThread) (chatthread.ChatThread, error)`

#### SafeMap

##### Methods

- `func (SafeMap) Delete(key K)`

- `func (SafeMap) Get(key K) (V, bool)`

- `func (SafeMap) Set(key K, value V)`

#### ThreadRepository

##### Methods

- `func (ThreadRepository) Delete(ctx context.Context, id uuid.UUID) error`

- `func (ThreadRepository) GetByID(ctx context.Context, id uuid.UUID) (chatthread.ChatThread, error)`

- `func (ThreadRepository) List(ctx context.Context) ([]chatthread.ChatThread, error)`

- `func (ThreadRepository) Save(ctx context.Context, thread chatthread.ChatThread) (chatthread.ChatThread, error)`
...
## Package `builders` (pkg/cli/builders)
...
- `func (ErrorHandler) Handle(err error, context string)`
  Handle processes an error with context and exits appropriately
  

- `func (ErrorHandler) HandleWithStack(err error, context string)`
...
## Package `commands` (pkg/cli/commands)
...
- `func (DocFlags) AddToCommand(cmd *cobra.Command)`
...
- Const: `[QueryParamLimit QueryParamPage]`
...
type RateLimitOptions struct {
    ...
    Storage string `env:"RATE_LIMIT_STORAGE" envDefault:"memory"`
...
- `func (RateLimitOptions) Validate() error`
...
- `func (RendererRegistry) Get(typeName string) (FieldRenderer, bool)`
  Get retrieves a renderer for the given type name
  Returns the renderer and true if found, nil and false otherwise
  

- `func (RendererRegistry) Has(typeName string) bool`
  Has checks if a renderer is registered for the given type name
  

- `func (RendererRegistry) Register(typeName string, renderer FieldRenderer)`
...
- `func (RendererRegistry) RegisteredTypes() []string`
  RegisteredTypes returns a slice of all registered type names
  

- `func (RendererRegistry) Unregister(typeName string)`
...
## Package `models` (pkg/crud/models)
...
- Var: `[ErrUnsupportedLocale ErrEmptyMultiLang ErrInvalidLocaleCode ErrValueTooLong ErrInvalidCharacters]`

- Const: `[MaxLocaleCodeLength MaxValueLength]`

---

## Package `defaults` (pkg/defaults)
...
- Var: `[ErrInvalidPhoneNumber ErrInvalidMessage ErrTokenRefreshFailed ErrNilResponse ErrNilContext ErrMessageTooLong ErrServiceUnavailable]`

---

## Package `models` (pkg/eskiz/models)
...
## Package `importpkg` (pkg/import)

### Types

#### BaseImportPageConfig
...
- `func (BaseImportPageConfig) GetAcceptedFileTypes() string`

- `func (BaseImportPageConfig) GetColumns() []ImportColumn`

- `func (BaseImportPageConfig) GetDescription() string`

- `func (BaseImportPageConfig) GetExampleRows() [][]string`

- `func (BaseImportPageConfig) GetHTMXConfig() HTMXConfig`

- `func (BaseImportPageConfig) GetLocalePrefix() string`

- `func (BaseImportPageConfig) GetSaveURL() string`

- `func (BaseImportPageConfig) GetTemplateDownloadURL() string`

- `func (BaseImportPageConfig) GetTitle() string`
...
- `func (CompositeValidator) Validate(value string, col string, row uint) error`
...
- `func (DateValidator) Validate(value string, col string, row uint) error`
...
- `func (DefaultErrorFactory) NewInvalidCellError(col string, row uint) error`

- `func (DefaultErrorFactory) NewValidationError(col, value string, rowNum uint, message string) error`

#### DefaultExcelProcessor
...
- `func (DefaultExcelProcessor) ProcessFile(ctx context.Context, fileID uint, handler ExcelRowHandler) error`
...
- `func (ExcelFileReader) ReadExcelRows(filePath string) ([][]string, error)`
...
- `func (MultiErrorProcessor) ProcessFileWithAllErrors(ctx context.Context, fileID uint, handler ExcelRowHandler) error`
...
- `func (MultiValidationError) Add(err error)`
  Add adds an error to the collection
  

- `func (MultiValidationError) Error() string`

- `func (MultiValidationError) HasErrors() bool`
...
- `func (NumericValidator) Validate(value string, col string, row uint) error`
...
- `func (OneOfValidator) Validate(value string, col string, row uint) error`
...
- `func (RequiredValidator) Validate(value string, col string, row uint) error`
...
- `func (ValidationError) Localize(l *i18n.Localizer) string`
...
- `func (MultipartData) AddField(key, value string) *MultipartData`

- `func (MultipartData) AddFile(fieldName, fileName string, content []byte) *MultipartData`

- `func (MultipartData) AddForm(formValues url.Values) *MultipartData`
...
- `func (Request) Expect(tb testing.TB) *Response`
...
- `func (Request) MultipartData(data *MultipartData) *Request`
...
- `func (TestEnvironment) WithTx(ctx context.Context) context.Context`
...
- `func (TestExcelBuilder) AddRow(row map[string]interface{}) *TestExcelBuilder`
  AddRow adds a data row to the Excel file
  

- `func (TestExcelBuilder) AddRows(rows ...map[string]interface{}) *TestExcelBuilder`
  AddRows adds multiple data rows to the Excel file
  

- `func (TestExcelBuilder) Build(t *testing.T) string`
  Build creates the Excel file and returns the file path
  

- `func (TestExcelBuilder) BuildBytes(t *testing.T) []byte`
  BuildBytes creates the Excel file and returns the content as bytes
  

- `func (TestExcelBuilder) WithHeaders(headers ...string) *TestExcelBuilder`
  WithHeaders sets the headers for the Excel file
  

- `func (TestExcelBuilder) WithSheet(name string) *TestExcelBuilder`
...
#### `func GetService(te *TestEnvironment) *T`
...
- `func (PageContext) Namespace(prefix string) *PageContext`
