...
watch coverage verbose docker score report prod linux docker-base docker-prod up down restart logs local stop reset seed migrate install help imports serve fmt:
	@:
