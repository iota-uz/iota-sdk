...
func UserToViewModel(entity user.User) *viewmodels.User {
	...
	vm := &viewmodels.User{
		...
		DirectPermissions:    mapping.MapViewModels(entity.Permissions(), PermissionToViewModel),
		EffectivePermissions: mapping.MapViewModels(user.EffectivePermissions(entity), PermissionToViewModel),
