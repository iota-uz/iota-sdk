...
CREATE TABLE uploads (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT uploads_tenant_hash_key UNIQUE (tenant_id, hash)
);
...
CREATE TABLE users (
    ...
    CONSTRAINT users_tenant_phone_key UNIQUE (tenant_id, phone)
);
...
CREATE TABLE user_groups (
    ...
    CONSTRAINT user_groups_tenant_name_key UNIQUE (tenant_id, name)
);
...
CREATE TABLE tabs (
    ...
    CONSTRAINT tabs_tenant_href_user_id_key UNIQUE (tenant_id, href, user_id)
);
