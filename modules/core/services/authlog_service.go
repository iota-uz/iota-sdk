...
func (s *AuthLogService) GetAll(ctx context.Context) ([]authlog.AuthLog, error) {
	return s.repo.GetAll(ctx)
}

func (s *AuthLogService) GetByID(ctx context.Context, id uint) (authlog.AuthLog, error) {
...
func (s *AuthLogService) Create(ctx context.Context, data authlog.AuthLog) error {
...
func (s *AuthLogService) Update(ctx context.Context, data authlog.AuthLog) error {
