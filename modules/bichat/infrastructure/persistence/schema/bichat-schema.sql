...
CREATE INDEX IF NOT EXISTS idx_bichat_messages_created_at
    ON bichat_messages(created_at);
...
CREATE INDEX IF NOT EXISTS idx_bichat_attachments_created_at
    ON bichat_attachments(created_at);
