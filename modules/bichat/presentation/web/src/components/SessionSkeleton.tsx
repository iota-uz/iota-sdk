 ...
 * Loading skeleton for session list using reusable Skeleton from @iota-uz/iota-sdk/bichat
 */
import { SkeletonGroup, ListItemSkeleton } from '@iota-uz/iota-sdk/bichat'
